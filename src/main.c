...
void on_update() {
    ...
    for (int i = 0; i < PARTICLE_COUNT; i++) {
        ...
        //         // p_back[j].velocity.x = p_front[j].velocity.x *
        //         // (p_front[j].mass - p_front[i].mass) * (2 *
        //         // p_front[i].velocity.x * p_front[i].mass) / (p_front[i].mass +
        //         // p_front[j].mass); p_back[j].velocity.y =
        //         // p_front[j].velocity.y * (p_front[j].mass - p_front[i].mass) *
        //         // (2 * p_front[i].velocity.y * p_front[i].mass) /
        //         // (p_front[i].mass + p_front[j].mass);
